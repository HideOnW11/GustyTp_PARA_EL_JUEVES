public class Entrada {
    ...
    public String telefonoComprador;     // Número de teléfono del comprador de la entrada
    ...
    public Entrada(int numero, String ubicacion, double precio) {
        ...
        this.telefonoComprador = "";    // Inicialmente no se ha asignado un número de teléfono de comprador
    }
